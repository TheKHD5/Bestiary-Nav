...
- **Levelling (Experimental):** use Rotation Solver to farm a chosen level range, patrol spawn areas, move on as BST levels up, and stop at a target level. Optional chocobo, food refresh, combat FATEs, Notorious Monster filtering, and auto respawn. The initial area catalog covers ARR targets up to level 49; live FATEs supplement it.
