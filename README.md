...
- **Levelling (Experimental):** target enemies +1 to +10 levels above BST. Choose a documented monster group and zone, or Automatic to fight all eligible types and move areas as you level. Optional chocobo, food, combat FATEs in Automatic mode, auto respawn, and a stop level. Toggle it beside **Capture all available**. The current catalog covers 44 ARR spawn groups up to level 49.
